...
nmds_16S_MB <- metaMDS(genus_otus_MB_16S, distance="bray", trace = FALSE, trymax=100) 
...
nmds_16S_FK <- metaMDS(genus_otus_FK_16S, distance="bray", trace = FALSE, trymax=100) 
