...
#write.csv(as.data.frame(MB_16S_prop@tax_table), "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/MB_16S_tax_table.csv")  #is this the best way to save biom files?
...
#write.csv(as.data.frame(MB_18S_prop@tax_table), "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/MB_18S_tax_table.csv")  #is this the best way to save biom files?
...
#write.csv(as.data.frame(MB_COI_prop@tax_table), "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/MB_COI_tax_table.csv")  #is this the best way to save biom files?
...
#write.csv(as.data.frame(MB_12S_prop@tax_table), "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/MB_12S_tax_table.csv")
...
# merge samples for fun... 
MB_all_tax_ps_ts_merge <- merge_samples(MB_all_tax_ps_ts,"collection_date",fun=mean) #merge samples
MB_all_tax_ps_ts_merge_df <- data.frame(MB_all_tax_ps_ts_merge@otu_table)
MB_all_tax_ps_ts_merge_df$collection_date <- row.names(MB_all_tax_ps_ts_merge_df)
# filter out bad taxa 
badTaxa_MB <- read.csv("/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/MB_badtaxa.csv", header=FALSE)
badTaxa_MB <- badTaxa_MB[[1]]

goodTaxa_MB <- setdiff(taxa_names(MB_all_tax_ps_ts), badTaxa_MB)

MB_all_tax_ps_rel = prune_taxa(goodTaxa_MB,MB_all_tax_ps_ts)
goodTaxa_MB_merge <- setdiff(taxa_names(MB_all_tax_ps_ts_merge), badTaxa_MB)
MB_all_tax_ps_ts_merge = prune_taxa(goodTaxa_MB_merge,MB_all_tax_ps_ts_merge)
MB_all_tax_ps_ts_merge = prune_taxa(taxa_sums(MB_all_tax_ps_ts_merge) > 0, MB_all_tax_ps_ts_merge) 
MB_merged_otu <- t(as.matrix(MB_all_tax_ps_ts_merge@otu_table))
MB_merged_otu_table <- sweep(MB_merged_otu,1,rowMaxs(MB_merged_otu),"/")

MB_all_merge <- data.frame(MB_all_tax_ps_ts_merge@otu_table)
MB_all_merge$collection_date <- row.names(MB_all_merge)

MB_all_tax_ps_rel = prune_taxa(taxa_sums(MB_all_tax_ps_rel) > 0, MB_all_tax_ps_rel) 
#MB_all_tax_ps_rel = transform_sample_counts(MB_all_tax_ps_rel,function(x) x / sum(x))
#saveRDS(MB_all_tax_ps_rel, "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/MB_all_tax_ps_rel.Rdata")  
...
#write.csv(MB_all_otu_table, "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/MB_all_otu_table.csv")  
#write.csv(MB_all_taxa_table, "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/MB_all_taxa_table.csv")
saveRDS(MB_all_otu_table, "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/MB_all_otu_table.Rdata")  
saveRDS(MB_merged_otu_table, "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/MB_merged_otu_table.Rdata")  
...
corMB <- cor(t(otus), method = "kendall")
  ...
  sum(abs(corMB)>0.7, na.rm=T) / length(corMB)  #using Kendall alpha value of tau = 0.62 (by simulation)
...
unique_kend_taxa <- as.character(unique(corMB$Var1))
...
net_MB = blockwiseModules(datExpr_MB, power = 5,
...
#pdf(file="/Users/anni_djurhuus/Documents/Projects/MBON/m2w/figs/modules_final_taxa.pdf",height=8,width=10)
...
#colnames(MEs_MB) = c("blue","dark grey","orange","green","yellow", "grey")
...
#pdf(file="/Users/anni_djurhuus/Documents/Projects/MBON/m2w/figs/trait_heatmap_rel_abund_no_badtaxa.pdf",height=8,width=10)
par(mar = c(6, 8.5, 3, 3));
...
#STEP 5
modules = c("#00b159", "#ffc425", "#00aedb","#f37735","#8c8c8c");
# Select module probes
probes = names(datExpr_MB)
...
colorh1= moduleColors_MB
cmd1=cmdscale(as.dist(modTOM),2)
sizeGrWindow(7, 6)
par(mfrow=c(1,1))
plot(cmd1, col=as.character(moduleColors_MB), main="MDS plot",
...
write.csv(cyt$edgeData, file = "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/network_data/MB_edge_final_taxa.csv")
write.csv(cyt$nodeData, file = "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/network_data/MB_node_final_taxa.csv")
...
module_taxa <- read.csv("/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/module_taxa.csv", header=TRUE)
yel_MB <- module_taxa[[1]]
red_MB <- module_taxa[[2]]
blue_MB <- module_taxa[[3]]
green_MB <- module_taxa[[4]]
dg_MB <- module_taxa[[5]]
black_MB <- module_taxa[[7]]
...
#saveRDS(res2_MB, "/Users/anni_djurhuus/Documents/Projects/MBON/m2w/google_drive/data/MEGAN6/post_decont/MB/taxa_cor_MB.Rdata")  
