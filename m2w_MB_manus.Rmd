...
MB_16S_m2w <- merge_phyloseq(otu_table(as.matrix(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/16S/MB_16S_otu_table.csv", row.names = 1,check.names = FALSE)), taxa_are_rows = TRUE),tax_table(as.matrix(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/16S/MB_16S_tax_table.csv", row.names = 1))),sample_data(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/16S/MB_16S_sam_table.csv", row.names = 1)))

MB_18S_m2w <- merge_phyloseq(otu_table(as.matrix(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/18S/MB_18S_otu_table.csv", row.names = 1,check.names = FALSE)), taxa_are_rows = TRUE),tax_table(as.matrix(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/18S/MB_18S_taxa_table.csv", row.names = 1))),sample_data(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/18S/MB_18S_sam_table.csv", row.names = 1)))

MB_COI_m2w <- merge_phyloseq(otu_table(as.matrix(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/COI/MB_COI_otu_table.csv", row.names = 1,check.names = FALSE)), taxa_are_rows = TRUE),tax_table(as.matrix(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/COI/MB_COI_taxa_table.csv", row.names = 1))),sample_data(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/COI/MB_COI_sam_table.csv", row.names = 1)))

MB_12S_m2w <- merge_phyloseq(otu_table(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/12S/MB_12S_otu_table.csv", row.names = 1, check.names = FALSE), taxa_are_rows = TRUE), tax_table(as.matrix(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/12S/MB_12S_taxa_table.csv", row.names = 1))), sample_data(read.csv(file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/12S/MB_12S_sam_data.csv",row.names = 1)))
```
...
#MB_16S_gen <- tax_glom(MB_16S_m2w, "Rank7")
#MB_18S_gen <- tax_glom(MB_18S_m2w, "Rank7")
#MB_COI_gen <- tax_glom(MB_COI_m2w, "Rank7")
#MB_12S_gen <- tax_glom(MB_12S_m2w, "Rank7")
...
#write.csv(as.data.frame(MB_16S_prop@tax_table), "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/16S/MB_16S_tax_table.csv")  #is this the best way to save biom files?
...
#write.csv(as.data.frame(MB_18S_prop@tax_table), "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/18S/MB_18S_tax_table.csv")  #is this the best way to save biom files?
...
#write.csv(as.data.frame(MB_COI_prop@tax_table), "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/COI/MB_COI_tax_table.csv")  #is this the best way to save biom files?
...
#write.csv(as.data.frame(MB_12S_prop@tax_table), "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/12S/MB_12S_tax_table.csv")
...
# filter out bad taxa 
badTaxa_MB <- read.csv("/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/MB_badtaxa.csv", header=FALSE)
...
#saveRDS(MB_all_tax_ps_rel, "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_all_tax_ps_rel.Rdata")  
...
write.csv(MB_all_otu_table, "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_all_otu_table.csv")  
write.csv(MB_merged_otu_table, "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_merged_otu_table.csv")  
```
...
# a<-readRDS("/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MB_all_tax_ps_rel.Rdata")
# 
...
length(unique(unlist(corMB[,1:2])))  #348 unique taxa
    
    #save(corMB, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/analysis/MBKendall.Rdata")
...
write.csv(as.data.frame(MB_all_filt@.Data), "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_all_filt.csv")
write.csv(as.data.frame(MB_merge_filt@.Data), "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_merge_filt.csv")
```
...
par(cex = 0.6);
#par(mar = c(0,4,2,0))
#pdf("/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/network/net_dendro_tau.pdf")
...
#load trait data
traitData_MB = read.csv("/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/metadata_MB_merged_sam.csv")
#dim(traitData_MB)
#names(traitData_MB)
...
#pdf("/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/network/net_dendro_tau_w_env.pdf")
...
#sizeGrWindow(9, 5)
#pdf("/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/network/pick_soft_threshold.pdf")
par(mfrow = c(1,2));
cex1 = 0.8;
...
pdf("/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/network/taxa_dendro_modules.pdf", height=7,width=10)
...
pdf("/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/dendro_modules.pdf", height=2)
par(cex = 0.7)
...
#pdf("/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/network/module_cor_envir.pdf")
#par(mar = c(6, 8.5, 3, 3));
...
#pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/heatmap_all_modules.pdf", height=12, width=15)
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/module_richness_time.pdf", height=4, width=4.5)
par(mar=c(3,4,1,4))
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/module_significance_chl.pdf", height=4, width=5)
...
write.csv(cyt$edgeData, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_edge.csv")
write.csv(cyt$nodeData, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_node.csv")
...
write.csv(cyt_blue$edgeData, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_edge_blue.csv")
write.csv(cyt_blue$nodeData, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_node_blue.csv")
...
write.csv(cyt_dg$edgeData, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_edge_dg.csv")
write.csv(cyt_dg$nodeData, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_node_dg.csv")
...
write.csv(qpcR:::cbind.na(blue_MB,dg_MB,orange_MB,green_MB,yel_MB, grey_MB), file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/all_module_taxa.csv")
...
write.csv(datExpr_MB_BG, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/datExpr_MB_BG.csv")
trophic_lev <- read.csv(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/subnetxtrophic_ordered_20181112.csv")
...
#pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/SPLS_network.pdf", height=10, width=12)
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/SPLS_heatmap_darkg_blue.pdf", height=6, width=9)
par(mar=c(1,1,1,1))
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/SPLS_heatmap_gr_yel_ora_bla.pdf", height=6, width=9)
par(mar=c(1,1,1,1))
...
write.csv(MB_merge_filt_t, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/merge_filt_t.csv")
...
Bacillariaceae <- cbind(data.frame(Abundance=MB_merge_filt_t$`f:Bacillariaceae`),data.frame(Date=MB_merge_filt_t$collection_date), Taxa=(c("Bacillariaceae")))

data_ggridges <- rbind(Otariidae,Carangidae,Temoridae,Syndiniaceae,Rhodospirillaceae,Bacillariaceae)
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/joyplot_dg.pdf",height=6,width=7)
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/joyplot_blue.pdf",height=6,width=7)
...
# Plot the chart.
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/trophic_pie_blue.pdf", height=5, width=11)
pie(trophic_blue,labels_blue, border=FALSE,col=c("lightcyan","lightblue","#00aedb","#2b8cbe","steelblue4"), cex=2)
dev.off()
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/trophic_pie_grey.pdf", height=5, width=11)
pie(trophic_grey,labels_grey, border=FALSE, col=c("grey95","grey80","grey60","grey40","grey20"),cex=2)
dev.off()
...
write.csv(con_blue, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/con_blue.csv")
trophic <- read.csv(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/subnetxtrophic_ordered_20181112.csv")
trophic_lev <- read.csv(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/subnetxtrophic_ordered_20181112.csv")
con_blue$trophic_lev <- trophic_lev$trophic_fv[match(con_blue$taxa, trophic_lev$taxa)]
dg_MB <- dg_MB[,1]
con_dg <- con[con$taxa %in% dg_MB, ]
write.csv(con_dg, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/con_dg.csv")
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/con_env.pdf", height=5, width=9)
par(mfrow=c(1,2))
par(mar=c(4,4,3,2.7))
...
#meta<-read.csv("/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/m2w_metadata_MB.csv")
#names(meta)
...
#pdf("/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/envirPCA.pdf")
autoplot(envir.PCA,
...
meta_bioenv<-read.csv("/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/m2w_metadata_MB.csv")
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/blue_dg_PA.pdf",height=6,width=6)
par(mfcol=c(2,1))
par(mar=c(0.5,5,3,4))
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/blue_dg_PA_env.pdf",height=6,width=6)
dif_SA<-read.csv("/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/dif_SA.csv")
par(mfrow=c(2,1))
par(mar=c(4,4,1,1))
...
diatoms <- read.csv(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/subnettroph_AD.csv")
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/diatom_dino.pdf",height=5,width=6)
par(mar=c(6,4,3,3))
...
polygon(subdate, sub.sst, col='gray70', border=NA, density=50) 
par(new=TRUE)
...
source("/Volumes/GoogleDrive/Shared drives/m2w_analysis/analysis/LagAnalysis.R")
lagMB <- LAGCOR(otus, lag = 1)
    ...
    #save(lagMB, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/analysis/LaggedKendall.Rdata")
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/Supplemental/obs_richness_PA.pdf",height=6,width=9)
par(mar=c(3,4,2,4.5))
par(mfrow=c(1,2))
...
#pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/Supplemental/heatmap.pdf",height=10,width=7)
...
par(mar=c(1,4,3,2))
#MB
plot(MB_merge_filt_t$`f:Bacillariaceae`~MB_merge_filt_t$collection_date,col="#E69F00",type="l", pch=16,lwd=2,ylab=c(""), xlab="",xaxt="n",yaxt="n",ylim=c(0,1.2))
...
#MB
#pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/Supplemental/correlation_top50.pdf",height=8,width=7)
...
#saveRDS(res2_MB, "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/taxa_cor_MB.Rdata")  
...
#ObservedData
  ...
  otus<-MB_merged_otu_table
    #readRDS("/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MB_merged_otu_table.Rdata")
  #filter by sd or some other measure of variance
  otus <- otus[specnumber(otus) > 1 , ]  #must occur in at least 2 time points, with zero abundance being a real data point in this case 
...
#pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/Supplemental/Kendall_correlations.pdf",height=6,width=9)
#ggplot(data=tmp, aes(y=Adjusted.P, x=Tau))+
#                  geom_smooth()+
#                  geom_point()+
#                  geom_vline(aes(xintercept = 0.70), color = "red", alpha = 0.5)+
...
gt = prune_taxa(gt,MB_merge_filt)
...
exp(z_gt)
#source("/Volumes/GoogleDrive/Shared drives/m2w_analysis/analysis/strongCorrsPlot.R")
pdf("/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/grey_strongCor.pdf", width = 10, height = 10)
strong.corrs.plot(log(z_gt+1), cutoff = 0.5)
dev.off()

############### BLUE ###########

bt <- as.character(c("f:Gonyaulacaceae","f:Prorocentraceae","f:Chrysolepidomonadaceae","f:Urechidae","f:Balaenopteridae","f:Euphausiidae","f:Rathkeidae"))
...
#source("/Volumes/GoogleDrive/Shared drives/m2w_analysis/analysis/strongCorrsPlot.R")
pdf("/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/blue_strongCor.pdf", width = 10, height = 10)
strong.corrs.plot(log(z+1), cutoff = 0.42)
dev.off()
...
con_green <- con[con$taxa %in% green_MB$taxa, ]
con_green$trophic_lev <- trophic_lev$trophic_fv[match(con_green$taxa, trophic_lev$taxa)]
write.csv(con_green, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/con_green.csv")

con_yel <- con[con$taxa %in% yel_MB, ]
con_yel$trophic_lev <- trophic_lev$trophic_fv[match(con_yel$taxa, trophic_lev$taxa)]
write.csv(con_yel, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/con_yel.csv")

con_orange <- con[con$taxa %in% orange_MB$taxa, ]
con_orange$trophic_lev <- trophic_lev$trophic_fv[match(con_orange$taxa, trophic_lev$taxa)]
write.csv(con_orange, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/con_orange.csv")

con_black <- con[con$taxa %in% grey_MB, ]
con_black$trophic_lev <- trophic_lev$trophic_fv[match(con_black$taxa, trophic_lev$taxa)]
write.csv(con_black, file = "/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/con_black.csv")
...
pdf(file="/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/con_cor_env_all.pdf", height=25, width=25)
par(mfrow=c(6,6))
...
```{r Climatology}
climate <- read.csv("/Volumes/GoogleDrive/Shared drives/m2w_analysis/data/MEGAN6/post_decontam/MB/MB_climatology.csv", header=T)

pdf("/Volumes/GoogleDrive/Shared drives/m2w_analysis/plots/climatology.pdf", width = 6, height = 5)
plot(climate$SST.Clim~dmy(climate$Date), type="l", ylim=c(12,20), lty=2,xaxt="n",xlab="", ylab="Climatology (SST)")
par(new=TRUE)
plot(climate$SST.mean~dmy(climate$Date),type="l",ylim=c(12,20),xaxt="n",xlab="", ylab="")
axis.Date(1,at=dmy(traitData_MB$collection_date),labels=format(dmy(traitData_MB$collection_date),"%b-%d"),las=2)
legend("topright",legend=c("Climatology", "SST"),ncol=1,col=c("black"), bty="n", lty=c(2,1), cex=0.7)
dev.off()
```
