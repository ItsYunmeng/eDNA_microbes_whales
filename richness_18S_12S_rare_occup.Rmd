...
#18S
taxa_18S=read.csv("/Users/anni_djurhuus/Documents/Projects/MBON/m2w/18S/Occ_Model_18S_taxa.csv",header=TRUE, row.names=1) #18S
...
glom_12S_p1 <- plot_richness(genus_glom_12S,x="DATE_TIME_GMT",title="COI Genus",measures = "Observed") + theme(axis.title.x=element_blank())
...
fam_glom_12S_p1 <- plot_richness(family_glom_12S,x="DATE_TIME_GMT",title="COI Family",measures = "Observed") + theme(axis.title.x=element_blank())
